...
public class SpaceshipManager : MonoBehaviour
{
    ...
    void EndReached(UnityEngine.Video.VideoPlayer vp)
    {
        ...
        eM.SetComponentData<LocalTransform>(spaceshipEntity, new LocalTransform {Position = new float3(0, 0, 0), Rotation = quaternion.LookRotationSafe(math.up(), -math.forward()), Scale = 1f});
